...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organizacion.codigo'
        db.delete_column('fed_organizacion', 'codigo')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Organizacion.codigo'
        raise RuntimeError("Cannot reverse this migration. 'Organizacion.codigo' and its values cannot be restored.")
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 21)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
