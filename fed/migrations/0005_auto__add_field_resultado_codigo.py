...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resultado.codigo'
        db.add_column('fed_resultado', 'codigo', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resultado.codigo'
        db.delete_column('fed_resultado', 'codigo')
