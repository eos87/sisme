...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('fed_proyecto', 'codigo', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Proyecto.id'
        raise RuntimeError("Cannot reverse this migration. 'Proyecto.id' and its values cannot be restored.")

        # Changing field 'Proyecto.codigo'
        db.alter_column('fed_proyecto', 'codigo', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
