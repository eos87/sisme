...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organizacion.telefono'
        db.delete_column('fed_organizacion', 'telefono')

        # Adding field 'Organizacion.telefono_1'
        db.add_column('fed_organizacion', 'telefono_1', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Organizacion.telefono_2'
        db.add_column('fed_organizacion', 'telefono_2', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Changing field 'Organizacion.obj_gral'
        db.alter_column('fed_organizacion', 'obj_gral', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Adding field 'Organizacion.telefono'
        db.add_column('fed_organizacion', 'telefono', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Deleting field 'Organizacion.telefono_1'
        db.delete_column('fed_organizacion', 'telefono_1')

        # Deleting field 'Organizacion.telefono_2'
        db.delete_column('fed_organizacion', 'telefono_2')

        # Changing field 'Organizacion.obj_gral'
        db.alter_column('fed_organizacion', 'obj_gral', self.gf('django.db.models.fields.CharField')(max_length=250))
