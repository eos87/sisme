...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PoblacionMetaIndirecta'
        db.create_table('fed_poblacionmetaindirecta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fed.Proyecto'])),
            ('grupo_etareo', self.gf('django.db.models.fields.IntegerField')()),
            ('hombres', self.gf('django.db.models.fields.IntegerField')()),
            ('mujeres', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('fed', ['PoblacionMetaIndirecta'])

        # Adding model 'PoblacionMetaDirecta'
        db.create_table('fed_poblacionmetadirecta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fed.Proyecto'])),
            ('grupo_etareo', self.gf('django.db.models.fields.IntegerField')()),
            ('hombres', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('fed', ['PoblacionMetaDirecta'])


    def backwards(self, orm):
        
        # Deleting model 'PoblacionMetaIndirecta'
        db.delete_table('fed_poblacionmetaindirecta')

        # Deleting model 'PoblacionMetaDirecta'
        db.delete_table('fed_poblacionmetadirecta')
