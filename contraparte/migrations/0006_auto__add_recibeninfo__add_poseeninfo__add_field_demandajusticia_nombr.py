...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RecibenInfo'
        db.create_table('contraparte_recibeninfo', (
        ...
        db.send_create_signal('contraparte', ['RecibenInfo'])

        # Adding model 'PoseenInfo'
        db.create_table('contraparte_poseeninfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('tipo_accion', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('contraparte', ['PoseenInfo'])

        # Adding field 'DemandaJusticia.nombre'
        db.add_column('contraparte_demandajusticia', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'ParticipacionComision.nombre'
        db.add_column('contraparte_participacioncomision', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'AgendaPublica.nombre'
        db.add_column('contraparte_agendapublica', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Denuncia.nombre'
        db.add_column('contraparte_denuncia', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RecibenInfo'
        db.delete_table('contraparte_recibeninfo')

        # Deleting model 'PoseenInfo'
        db.delete_table('contraparte_poseeninfo')

        # Deleting field 'DemandaJusticia.nombre'
        db.delete_column('contraparte_demandajusticia', 'nombre')

        # Deleting field 'ParticipacionComision.nombre'
        db.delete_column('contraparte_participacioncomision', 'nombre')

        # Deleting field 'AgendaPublica.nombre'
        db.delete_column('contraparte_agendapublica', 'nombre')

        # Deleting field 'Denuncia.nombre'
        db.delete_column('contraparte_denuncia', 'nombre')
