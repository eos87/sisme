...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoseenInfo.hom_ninos'
        db.add_column('contraparte_poseeninfo', 'hom_ninos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_adols'
        db.add_column('contraparte_poseeninfo', 'hom_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_jovenes'
        db.add_column('contraparte_poseeninfo', 'hom_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_adults'
        db.add_column('contraparte_poseeninfo', 'hom_adults', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_disca_ninos'
        db.add_column('contraparte_poseeninfo', 'hom_disca_ninos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_disca_adols'
        db.add_column('contraparte_poseeninfo', 'hom_disca_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_disca_jovenes'
        db.add_column('contraparte_poseeninfo', 'hom_disca_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_disca_adultos'
        db.add_column('contraparte_poseeninfo', 'hom_disca_adultos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_etnia_ninos'
        db.add_column('contraparte_poseeninfo', 'hom_etnia_ninos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_etnia_adols'
        db.add_column('contraparte_poseeninfo', 'hom_etnia_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_etnia_jovenes'
        db.add_column('contraparte_poseeninfo', 'hom_etnia_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_etnia_adultos'
        db.add_column('contraparte_poseeninfo', 'hom_etnia_adultos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_vih_ninos'
        db.add_column('contraparte_poseeninfo', 'hom_vih_ninos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_vih_adols'
        db.add_column('contraparte_poseeninfo', 'hom_vih_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_vih_jovenes'
        db.add_column('contraparte_poseeninfo', 'hom_vih_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.hom_vih_adultos'
        db.add_column('contraparte_poseeninfo', 'hom_vih_adultos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PoseenInfo.hom_ninos'
        db.delete_column('contraparte_poseeninfo', 'hom_ninos')

        # Deleting field 'PoseenInfo.hom_adols'
        db.delete_column('contraparte_poseeninfo', 'hom_adols')

        # Deleting field 'PoseenInfo.hom_jovenes'
        db.delete_column('contraparte_poseeninfo', 'hom_jovenes')

        # Deleting field 'PoseenInfo.hom_adults'
        db.delete_column('contraparte_poseeninfo', 'hom_adults')

        # Deleting field 'PoseenInfo.hom_disca_ninos'
        db.delete_column('contraparte_poseeninfo', 'hom_disca_ninos')

        # Deleting field 'PoseenInfo.hom_disca_adols'
        db.delete_column('contraparte_poseeninfo', 'hom_disca_adols')

        # Deleting field 'PoseenInfo.hom_disca_jovenes'
        db.delete_column('contraparte_poseeninfo', 'hom_disca_jovenes')

        # Deleting field 'PoseenInfo.hom_disca_adultos'
        db.delete_column('contraparte_poseeninfo', 'hom_disca_adultos')

        # Deleting field 'PoseenInfo.hom_etnia_ninos'
        db.delete_column('contraparte_poseeninfo', 'hom_etnia_ninos')

        # Deleting field 'PoseenInfo.hom_etnia_adols'
        db.delete_column('contraparte_poseeninfo', 'hom_etnia_adols')

        # Deleting field 'PoseenInfo.hom_etnia_jovenes'
        db.delete_column('contraparte_poseeninfo', 'hom_etnia_jovenes')

        # Deleting field 'PoseenInfo.hom_etnia_adultos'
        db.delete_column('contraparte_poseeninfo', 'hom_etnia_adultos')

        # Deleting field 'PoseenInfo.hom_vih_ninos'
        db.delete_column('contraparte_poseeninfo', 'hom_vih_ninos')

        # Deleting field 'PoseenInfo.hom_vih_adols'
        db.delete_column('contraparte_poseeninfo', 'hom_vih_adols')

        # Deleting field 'PoseenInfo.hom_vih_jovenes'
        db.delete_column('contraparte_poseeninfo', 'hom_vih_jovenes')

        # Deleting field 'PoseenInfo.hom_vih_adultos'
        db.delete_column('contraparte_poseeninfo', 'hom_vih_adultos')
    ...
    models = {
        ...
        'contraparte.poseeninfo': {
            ...
            'hom_adults': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
