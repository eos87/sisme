...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('contraparte_agendapublica', 'tipo_accion_id')

        # Adding field 'AgendaPublica.tipo_accion2'
        db.add_column('contraparte_agendapublica', 'tipo_accion2', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('contraparte_agendapublica', 'tipo_accion', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contraparte.AccionAgenda']), keep_default=False)
    ...
    models = {
        ...
        'contraparte.agendapublica': {
            ...
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'tema': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fed.Tema']"}),
            'tipo_accion2': ('django.db.models.fields.IntegerField', [], {})
        },
