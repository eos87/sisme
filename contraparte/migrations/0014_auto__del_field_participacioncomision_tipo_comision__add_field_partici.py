...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ParticipacionComision.tipo_comision'
        db.delete_column('contraparte_participacioncomision', 'tipo_comision_id')

        # Adding field 'ParticipacionComision.comision'
        db.add_column('contraparte_participacioncomision', 'comision', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ParticipacionComision.tipo_comision'
        db.add_column('contraparte_participacioncomision', 'tipo_comision', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contraparte.Comision']), keep_default=False)

        # Deleting field 'ParticipacionComision.comision'
        db.delete_column('contraparte_participacioncomision', 'comision')
