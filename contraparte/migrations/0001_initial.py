...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Informe'
        db.create_table('contraparte_informe', (
        ...
        db.send_create_signal('contraparte', ['Informe'])


    def backwards(self, orm):
        
        # Deleting model 'Informe'
        db.delete_table('contraparte_informe')
