...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlanEstrategico'
        db.create_table('contraparte_planestrategico', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('utiliza_plan', self.gf('django.db.models.fields.IntegerField')()),
            ('manera', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['PlanEstrategico'])

        # Adding model 'DenunciaInterpuesta'
        db.create_table('contraparte_denunciainterpuesta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('tipo_denuncia', self.gf('django.db.models.fields.IntegerField')()),
            ('instancia_administra', self.gf('django.db.models.fields.IntegerField')()),
            ('situacion_denuncia', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['DenunciaInterpuesta'])

        # Adding model 'ReferenciaContraReferencia'
        db.create_table('contraparte_referenciacontrareferencia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('instancia', self.gf('django.db.models.fields.IntegerField')()),
            ('tipo_referencia', self.gf('django.db.models.fields.IntegerField')()),
            ('atendido_personal_pertinente', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['ReferenciaContraReferencia'])

        # Adding model 'AtencionMujer'
        db.create_table('contraparte_atencionmujer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('organizacion', self.gf('django.db.models.fields.IntegerField')()),
            ('tipo_poblacion', self.gf('django.db.models.fields.IntegerField')()),
            ('plan_vida', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['AtencionMujer'])

        # Adding model 'MedirReportar'
        db.create_table('contraparte_medirreportar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('ha_mejorado', self.gf('django.db.models.fields.IntegerField')()),
            ('manera', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['MedirReportar'])

        # Adding model 'CasoAtendido'
        db.create_table('contraparte_casoatendido', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('tipo_caso', self.gf('django.db.models.fields.IntegerField')()),
            ('situacion_caso', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['CasoAtendido'])

        # Adding model 'CapacidadAdmitiva'
        db.create_table('contraparte_capacidadadmitiva', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('ha_mejorado', self.gf('django.db.models.fields.IntegerField')()),
            ('atraves', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('contraparte', ['CapacidadAdmitiva'])


    def backwards(self, orm):
        
        # Deleting model 'PlanEstrategico'
        db.delete_table('contraparte_planestrategico')

        # Deleting model 'DenunciaInterpuesta'
        db.delete_table('contraparte_denunciainterpuesta')

        # Deleting model 'ReferenciaContraReferencia'
        db.delete_table('contraparte_referenciacontrareferencia')

        # Deleting model 'AtencionMujer'
        db.delete_table('contraparte_atencionmujer')

        # Deleting model 'MedirReportar'
        db.delete_table('contraparte_medirreportar')

        # Deleting model 'CasoAtendido'
        db.delete_table('contraparte_casoatendido')

        # Deleting model 'CapacidadAdmitiva'
        db.delete_table('contraparte_capacidadadmitiva')
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 22)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 22)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 22)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
