...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoseenInfo.hom_adultos'
        db.add_column('contraparte_poseeninfo', 'hom_adultos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PoseenInfo.hom_adultos'
        db.delete_column('contraparte_poseeninfo', 'hom_adultos')
