...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PoseenInfo.tipo_poblacion'
        db.delete_column('contraparte_poseeninfo', 'tipo_poblacion')

        # Deleting field 'PoseenInfo.mujeres'
        db.delete_column('contraparte_poseeninfo', 'mujeres')

        # Deleting field 'PoseenInfo.hombres'
        db.delete_column('contraparte_poseeninfo', 'hombres')

        # Deleting field 'PoseenInfo.segmento_poblacional'
        db.delete_column('contraparte_poseeninfo', 'segmento_poblacional')

        # Adding field 'PoseenInfo.muj_ninas'
        db.add_column('contraparte_poseeninfo', 'muj_ninas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_adols'
        db.add_column('contraparte_poseeninfo', 'muj_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_jovenes'
        db.add_column('contraparte_poseeninfo', 'muj_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_adultas'
        db.add_column('contraparte_poseeninfo', 'muj_adultas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_disca_ninas'
        db.add_column('contraparte_poseeninfo', 'muj_disca_ninas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_disca_adols'
        db.add_column('contraparte_poseeninfo', 'muj_disca_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_disca_jovenes'
        db.add_column('contraparte_poseeninfo', 'muj_disca_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_disca_adultas'
        db.add_column('contraparte_poseeninfo', 'muj_disca_adultas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_etnia_ninas'
        db.add_column('contraparte_poseeninfo', 'muj_etnia_ninas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_etnia_adols'
        db.add_column('contraparte_poseeninfo', 'muj_etnia_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_etnia_jovenes'
        db.add_column('contraparte_poseeninfo', 'muj_etnia_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_etnia_adultas'
        db.add_column('contraparte_poseeninfo', 'muj_etnia_adultas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_vih_ninas'
        db.add_column('contraparte_poseeninfo', 'muj_vih_ninas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_vih_adols'
        db.add_column('contraparte_poseeninfo', 'muj_vih_adols', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_vih_jovenes'
        db.add_column('contraparte_poseeninfo', 'muj_vih_jovenes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.muj_vih_adultas'
        db.add_column('contraparte_poseeninfo', 'muj_vih_adultas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PoseenInfo.tipo_poblacion'
        raise RuntimeError("Cannot reverse this migration. 'PoseenInfo.tipo_poblacion' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PoseenInfo.mujeres'
        raise RuntimeError("Cannot reverse this migration. 'PoseenInfo.mujeres' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PoseenInfo.hombres'
        raise RuntimeError("Cannot reverse this migration. 'PoseenInfo.hombres' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PoseenInfo.segmento_poblacional'
        raise RuntimeError("Cannot reverse this migration. 'PoseenInfo.segmento_poblacional' and its values cannot be restored.")

        # Deleting field 'PoseenInfo.muj_ninas'
        db.delete_column('contraparte_poseeninfo', 'muj_ninas')

        # Deleting field 'PoseenInfo.muj_adols'
        db.delete_column('contraparte_poseeninfo', 'muj_adols')

        # Deleting field 'PoseenInfo.muj_jovenes'
        db.delete_column('contraparte_poseeninfo', 'muj_jovenes')

        # Deleting field 'PoseenInfo.muj_adultas'
        db.delete_column('contraparte_poseeninfo', 'muj_adultas')

        # Deleting field 'PoseenInfo.muj_disca_ninas'
        db.delete_column('contraparte_poseeninfo', 'muj_disca_ninas')

        # Deleting field 'PoseenInfo.muj_disca_adols'
        db.delete_column('contraparte_poseeninfo', 'muj_disca_adols')

        # Deleting field 'PoseenInfo.muj_disca_jovenes'
        db.delete_column('contraparte_poseeninfo', 'muj_disca_jovenes')

        # Deleting field 'PoseenInfo.muj_disca_adultas'
        db.delete_column('contraparte_poseeninfo', 'muj_disca_adultas')

        # Deleting field 'PoseenInfo.muj_etnia_ninas'
        db.delete_column('contraparte_poseeninfo', 'muj_etnia_ninas')

        # Deleting field 'PoseenInfo.muj_etnia_adols'
        db.delete_column('contraparte_poseeninfo', 'muj_etnia_adols')

        # Deleting field 'PoseenInfo.muj_etnia_jovenes'
        db.delete_column('contraparte_poseeninfo', 'muj_etnia_jovenes')

        # Deleting field 'PoseenInfo.muj_etnia_adultas'
        db.delete_column('contraparte_poseeninfo', 'muj_etnia_adultas')

        # Deleting field 'PoseenInfo.muj_vih_ninas'
        db.delete_column('contraparte_poseeninfo', 'muj_vih_ninas')

        # Deleting field 'PoseenInfo.muj_vih_adols'
        db.delete_column('contraparte_poseeninfo', 'muj_vih_adols')

        # Deleting field 'PoseenInfo.muj_vih_jovenes'
        db.delete_column('contraparte_poseeninfo', 'muj_vih_jovenes')

        # Deleting field 'PoseenInfo.muj_vih_adultas'
        db.delete_column('contraparte_poseeninfo', 'muj_vih_adultas')
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 1)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 1)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 1)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
