...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoseenInfo.lgbt_trans'
        db.add_column('contraparte_poseeninfo', 'lgbt_trans', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.lgbt_lesbi'
        db.add_column('contraparte_poseeninfo', 'lgbt_lesbi', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.lgbt_gay'
        db.add_column('contraparte_poseeninfo', 'lgbt_gay', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoseenInfo.lgbt_hsh'
        db.add_column('contraparte_poseeninfo', 'lgbt_hsh', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PoseenInfo.lgbt_trans'
        db.delete_column('contraparte_poseeninfo', 'lgbt_trans')

        # Deleting field 'PoseenInfo.lgbt_lesbi'
        db.delete_column('contraparte_poseeninfo', 'lgbt_lesbi')

        # Deleting field 'PoseenInfo.lgbt_gay'
        db.delete_column('contraparte_poseeninfo', 'lgbt_gay')

        # Deleting field 'PoseenInfo.lgbt_hsh'
        db.delete_column('contraparte_poseeninfo', 'lgbt_hsh')
