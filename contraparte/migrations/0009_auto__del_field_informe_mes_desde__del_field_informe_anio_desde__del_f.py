...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Informe.mes'
        db.add_column('contraparte_informe', 'mes', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Informe.anio'
        db.add_column('contraparte_informe', 'anio', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Informe.mes_desde'
        raise RuntimeError("Cannot reverse this migration. 'Informe.mes_desde' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Informe.anio_desde'
        raise RuntimeError("Cannot reverse this migration. 'Informe.anio_desde' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Informe.mes_hasta'
        raise RuntimeError("Cannot reverse this migration. 'Informe.mes_hasta' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Informe.anio_hasta'
        raise RuntimeError("Cannot reverse this migration. 'Informe.anio_hasta' and its values cannot be restored.")

        # Deleting field 'Informe.mes'
        db.delete_column('contraparte_informe', 'mes')

        # Deleting field 'Informe.anio'
        db.delete_column('contraparte_informe', 'anio')
