...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DemandaJusticia'
        db.create_table('contraparte_demandajusticia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('tipo_accion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.AccionDemanda'])),
            ('poblacion_discriminada', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['DemandaJusticia'])
        ...
        db.create_table('contraparte_denuncia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('informe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contraparte.Informe'])),
            ('situacion', self.gf('django.db.models.fields.IntegerField')()),
            ('tipo_poblacion', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('contraparte', ['Denuncia'])

        # Deleting field 'ParticipacionComision.tipo_accion'
        db.delete_column('contraparte_participacioncomision', 'tipo_accion')


    def backwards(self, orm):
        
        # Deleting model 'DemandaJusticia'
        db.delete_table('contraparte_demandajusticia')

        # Deleting model 'AccionDemanda'
        db.delete_table('contraparte_acciondemanda')

        # Deleting model 'Denuncia'
        db.delete_table('contraparte_denuncia')

        # User chose to not deal with backwards NULL issues for 'ParticipacionComision.tipo_accion'
        raise RuntimeError("Cannot reverse this migration. 'ParticipacionComision.tipo_accion' and its values cannot be restored.")
    ...
    models = {
        ...
        'fed.organizacion': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 15)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fed.proyecto': {
            ...
            'fecha_fin': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 15)'}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 15)'}),
